...
//float f;
  ...
  measuredLevel = BSP_ADC_ReadChannels(ADC_CHANNEL_11);    //Natan
 // batteryLevelmV = (uint16_t)((measuredLevel * 3300U * 1.47F) / 4096U);
  batteryLevelmV = (uint16_t)((measuredLevel * 3300U * 1.464F) / 4096U);
/*
  batteryLevelmV = measuredLevel;
  batteryLevelmV = (batteryLevelmV * 3300U) / 4096U;
  batteryLevelmV = (uint16_t)(batteryLevelmV * 1.47);
  */
/*
  if (measuredLevel == 0) {
    batteryLevelmV = 0;
...
//    batteryLevelmV = (measuredLevel * 25000U) / 15000U;
	  ...
	  f = measuredLevel * 1.47;
	  f = f*(3300/4096);
	  batteryLevelmV = (uint16_t)f;    //Natan

//    batteryLevelmV = (uint16_t)((measuredLevel * 1.47)*(3300/4096));    //Natan
//    batteryLevelmV = measuredLevel;    //Natan


  }
*/
//  return measuredLevel;  // Natan
