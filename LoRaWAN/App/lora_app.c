...
static void SendTxData(void)
{
  ...
  uint8_t batteryLevel = GetBatteryLevel();  // percentage of battery charge.
  ...
  CayenneLppAddDigitalInput(channel++, batteryLevel);  // Natan
/*
...
*/
 ...
 // AppData.Buffer[i++] = AppLedStateOn;
  AppData.Buffer[i++] = batteryLevel;   // Natan
...
//    AppData.Buffer[i++] = 0;
//    AppData.Buffer[i++] = 0;
    AppData.Buffer[i++] = (uint8_t)((batteryLevelmV >> 8) & 0xFF);  // Natan
    AppData.Buffer[i++] = (uint8_t)(batteryLevelmV & 0xFF);         // Natan
